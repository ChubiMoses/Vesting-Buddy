...
def run_eval():
    ...
    print(f"🚀 Starting Strategist Agent Prompt Eval using {model_name}")

    dataset_name = "Strategist_Prompt_Eval"
    dataset = client.get_or_create_dataset(dataset_name)
    
    # Load dataset from JSONL
    # Path: ../datasets/strategist.jsonl
    ...
    evaluate_prompt(
        ...
        model=model_name,
        experiment_name="strategist_prompt_eval",
        scoring_metrics=[
            Contains(reference="Reasoning Steps", name="Contains Reasoning"),
            Contains(reference="Recommendation", name="Contains Recommendation"),
        ]
    )
